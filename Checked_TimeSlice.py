...
def generate_time_slices(Slice = 'M'):
    ...
    gr_Df.drop(['ClmProcedureCode_1','ClmProcedureCode_2','ClmProcedureCode_3','ClmProcedureCode_4','ClmProcedureCode_5','ClmProcedureCode_6'] , axis=1).to_csv("checked_time_slice_"+Slice+".csv")
    return gr_Df
# Paramters
##  'W'  : weekly frequency
...
### Non Fraud Claims
print("Non Fraudulent Tranactions Grouped With Respect To One Month")
...
### Fraud Claims
print("Fraudulent Tranactions Grouped With Respect To One Month")
